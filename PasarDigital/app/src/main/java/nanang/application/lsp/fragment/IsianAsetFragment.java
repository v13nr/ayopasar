...
public class IsianAsetFragment extends Fragment {
    ...
    private void loadDetail() {
        ...
        webView.loadUrl("file:///android_asset/html/isian.html?nama_desa="+ CommonUtilities.toTitleCase(data_user.getDesa().toLowerCase()));
    }
    ...
    final class IJavascriptHandler {
        ...
        @JavascriptInterface
        public void gotoSaveAset(final String jenisbarang, final String kodebarang, final String identitasbarang, final String jumlah_barang, final String apbdesa, final String lain, final String kekayaan, final String tanggal_asset, final String keterangan) {
            getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    ((MainActivity) getActivity()).prosesSaveAset(jenisbarang, kodebarang, identitasbarang, jumlah_barang, apbdesa, lain, kekayaan, tanggal_asset, keterangan);
