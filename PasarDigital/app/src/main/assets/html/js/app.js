...
function win(r) {
        ...
        function uploadPhoto(imageURI) {
            ...
            ft.upload(imageURI, encodeURI("http://aset.lpkpd.org/smc/upload_touch.php?latlong=qq&judul=007&keterangan=008"), win, fail, options);
		...
		function simpanKebersihan(){
			...
			$.ajax({
				type	: "POST",
				url		: "http://aset.lpkpd.org/smc/upload_text.php?gambar="+gambar,		 
