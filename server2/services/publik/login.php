<?php 
	...
	function action_getAuth()
	{
		...
		$sql = "SELECT *, email as user, nama_lengkap AS nama, hp AS desa,
		    nik as lokal, nama_bank as kades, norek as sekdes, npwp as pengurus, nama_lengkap as alamatdesa
		    FROM anggota WHERE email = '".$_POST["user"]."' AND pass= '".$_POST["pass"]."'";
